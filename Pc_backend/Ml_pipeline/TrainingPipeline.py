...
DEFAULT_HOLDOUT_TOKENS = [
    "Kiwi-Joker-2",
    "(Real Kiwi-Joker)",
    # Additional spoofed holdout sessions recorded 2026-05-19.
    # Covers the walking same-route hard case, two driving
    # same-motion middle cases, and two easy cross-motion cases.
    # Joint files use the YYYYMMDD date format.
    "20260519",
    # Device A ground-truth (legitimate) recordings from the same
    # 2026-05-19 sessions. Device A files use the DDMMYY date
    # format, so they need their own token.
    "190526",
]
